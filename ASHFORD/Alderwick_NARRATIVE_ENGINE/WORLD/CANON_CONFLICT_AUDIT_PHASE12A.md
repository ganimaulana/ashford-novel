...
**Canon Sources:**
- CHARACTER_REGISTRY.md (Alderwick_NARRATIVE_ENGINE/CHARACTERS/)
- Individual character files (WORLD_BIBLE/04_CHARACTERS/characters/)
- characters.json (Alderwick_NARRATIVE_ENGINE/CHARACTERS/data/)
...
| Source | Reference |
|--------|-----------|
| CHARACTER_REGISTRY.md line 157-158 | "**occupation:** History student, Alderwick University" |
...
**Actual Canon Character:** Daniel James Carter (History student, Alderwick University)
