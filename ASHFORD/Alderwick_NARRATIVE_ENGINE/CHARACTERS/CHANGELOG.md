...
- **Created:** `Alderwick_NARRATIVE_ENGINE/README.md` — Engine overview
- **Updated:** `Alderwick_NARRATIVE_ENGINE/INDEX.md` — Added Character Network (CN) to system index
...
These new documents integrate with all existing Alderwick Narrative Engine systems:
...
**Authority Level:** These documents define the narrative spine of Alderwick. All future development should align with these principles unless explicitly revised by author decision.
