...
**Legend:**
- **Type:** Character / Organization / Faction / Location / Mystery / Symbol / Object / Document / Historical Event / Conflict / Supernatural
- **Status:** CANON / WORKING CANON / HIDDEN CANON / PLANNED / PROPOSED / DRAFT / OBSOLETE / CONFLICT / DEPRECATED / OPEN
- **Leon Knows?** / **Reader Knows?:** YES / NO / PARTIAL
- **Reveal Priority:** IMMEDIATE / EARLY (Ch 9–16) / MID (Ch 17–24) / LATE (Ch 25–40) / ENDGAME / NEVER / UNRESOLVED

| Element | Type | Source | Related Elements | Status | Leon Knows? | Reader Knows? | Reveal Priority |
|---|---|---|---|---|---|---|---|
| **Leon Ashcroft** | Character | CHAPTERS 1–8, CHARACTERS/, WORLD_BIBLE/ | Aurelius, Helen, Daniel, Margaret, Arthur, Thomas Wren, Hidden Circle, symbol, envelope | CANON | YES (self) | YES | — |
| **Helen Margaret Ashcroft** | Character | CHAPTERS 1–8, CHARACTERS/, WORLD_BIBLE/ | Leon, Aurelius, Bellweather House, portrait | CANON / HIDDEN | PARTIAL (not full name) | PARTIAL (not full name) | LATE |
| **Daniel James Carter** | Character | CHAPTERS 2–8, CHARACTERS/ | Leon, Margaret, Arthur, Academy, thesis | CANON | YES | YES | — |
| **Arthur Edmund Bell** | Character | CHAPTERS 2–8, CHARACTERS/ | Leon, Bellweather House, symbol, network | CANON | PARTIAL (not network role) | PARTIAL | MID |
| **Margaret Eleanor Whitmore** | Character | CHAPTERS 2–8, CHARACTERS/ | Leon, Daniel, Arthur, tearoom, Aurelius | CANON | PARTIAL (not deeper knowledge) | PARTIAL | MID |
| **Thomas Wren** | Character | WORLD_BIBLE/04_CHARACTERS/, CANON docs | Aurelius, Leon, notebook, key, Bellweather Estate | CANON / DECEASED | NO (not yet met at Ch 8) | NO (not yet introduced) | MID (Ch 11 deathbed) |
...
| **Mysterious Man (Inn)** | Character | CHAPTER 1, CANON_EARLY_LATE_RETURN.md | Leon, Hidden Circle candidate | UNNAMED / AMBIGUOUS | YES (met) | YES | MID |
...
| **Bellweather House** | Location | CHAPTERS 1–8, 03_BUILDINGS/, WORLD_BIBLE/03_BUILDINGS/Bellweather_House.md | Aurelius, Thomas Wren, symbol, no number, "removed from active list" | WORKING CANON | YES | YES | MID–LATE (interior) |
...
| **Greyhaven** | Location | 01_GEOGRAPHY/Greyhaven.md | Coastal town, maritime paranormal | PLANNED | NO | NO | MID–LATE |
| **Hollow Wood** | Location | 01_GEOGRAPHY/Natural_Features.md | Woodland, isolation | PLANNED | NO | NO | MID–LATE |
| **North Downs** | Location | 01_GEOGRAPHY/Natural_Features.md | Ridge, clearer weather | FRAMEWORK | NO | NO | N/A |
| **Station District** | Location | 01_GEOGRAPHY/Station_District.md | Railway hub (2006) | DEPRECATED | — | — | NEVER (2006) |
| **University District** | Location | 01_GEOGRAPHY/University_District.md | Campus, students | PLANNED | NO | NO | MID |
| **Pembroke & Clarke Letter** | Document | 12_NOVEL/Pembroke_Clarke_Letter.md, CHAPTER 1 | Aurelius, No. 13, will/estate | CANON | YES | YES | MID (full contents) |
| **Room Key (circle symbol)** | Object | CHAPTER 1 | Symbol, Leon's room | CANON | YES | YES | — |
| **1798 Key-Found Notice** | Document | CHAPTER 1 | Key, house, 18 years prior | CANON | YES | YES | MID |
| **Helen's Portrait** | Object | CHAPTER 1 | Boy ~16, "13 November 1816" inscription | CANON | YES (partially) | YES (more than Leon) | MID |
| **Leon's Notebook** | Object/Document | CHAPTER 1 | Leon's observations, dream, symbols | CANON | YES | YES | — |
...
| **12–13 November** | Symbol/Motif | CHAPTER 1, CANON docs | Arrival vs. expected, portrait | OPEN | YES (dates) | YES | LATE |
...
| **M.R./J.T./M.B. identities** | Mystery | CHAPTER 7 | Aurelius's associates | HIDDEN | PARTIAL | PARTIAL | LATE |
| **Boy in Dream/Portrait** | Mystery | CHAPTER 1 | Helen's waiting, Leon | OPEN | NO | NO | LATE |
| **Why bell rang** | Mystery | CHAPTER 1 | Long silence | OPEN | NO | NO | MID |
| **Leon's orphan background** | Mystery | CANON docs (conflict) | Medallion, box, childhood | CANON CONFLICT | UNRESOLVED | UNRESOLVED | UNRESOLVED |
| **Why 12 Nov vs 13 Nov** | Mystery | CHAPTER 1, CANON docs | Early/late mechanism | OPEN | PARTIAL | PARTIAL | LATE |
| **Leon's "Echo" connection (Police)** | Supernatural | ARCHIVE/LEGACY_2006/Police_Officer_Station.md | Past-trace perception | DEPRECATED / ARCHIVED | NO | NO | LATE |
| **Date-trigger mechanism** | Supernatural | CANON docs (conflict) | Dreams, dates | CANON CONFLICT | NO | NO | UNRESOLVED |
| **Leon vs. envelope sender** | Conflict | CHAPTERS 1, 5, 8 | Anonymous threat | ACTIVE | PARTIAL | PARTIAL | MID |
...
**Statistical Summary:**
- Total index entries: 70+
- Characters: 21 (including 5 new political characters)
- Organizations/Factions: 3 (plus 3 unidentified individuals)
- Locations: 17
- Mysteries: 12
- Symbols/Motifs: 7
- Objects/Documents: 11
- Supernatural elements: 2
- Conflicts: 4 major + multiple hidden

**Index Notes:**
- [CANON CONFLICT] entries (medallion, wooden box, orphan background, date-trigger) require author resolution before use in narrative.
- [DEPRECATED] entries (Station District, 2006 material) must not be used for 1816 narrative.
- [OBSOLETE] entries (Edwin Ashcroft) must not be used at all.
- [PROPOSED] entries require author approval before use.
- [DRAFT] entries are proposed but not yet approved — political characters in 16_GOVERNMENT/ are now APPROVED pending cast reconciliation.

---

**END OF GLOBAL WORLD INDEX**