...
1. This document is the visual canon for major recurring characters.
2. Existing manuscript facts take precedence over newly proposed details.
3. New visual details become canon only after author approval.
4. First introductions should receive the strongest physical description.
5. Later appearances should use selective recurring visual cues rather than repeating full descriptions.
6. Clothing must remain historically appropriate to 1816 Britain.
...
| Character | Existing Visual Description | Priority Level |
|-----------|---------------------------|----------------|
...
### YSABEL NOTT (the dark-coat woman)
...
### ELIAS MARR (collector of erased objects)

**Status:** CONFIRMED — keeper of the book of origins
...
### THE OLD MAN (society elder)

**Status:** CONFIRMED — presides over the nameless society
