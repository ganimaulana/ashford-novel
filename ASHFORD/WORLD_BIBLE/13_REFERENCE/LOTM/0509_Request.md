...
He believed that such an action would divert the attention of the undead monsters which only had one head left from the others, leaving the copper, ancient whistle as the only thing in their “eyes!”
...
Main Tank. A term used in gaming for a character that takes on all the aggro and damage.
