...
**Date:** 2026-09-03  
**Purpose:** Highest-level story architecture for the Gear system. This document sits above `GEAR_STORY_ARCHITECTURE.md`, `GEAR_COMPONENT_PROFILES.md`, and `DOOR_GEAR_SYSTEM.md`. It defines the narrative engine, canon constraints, and design rules. Individual profiles and detailed progression are in child documents.
  ...
  > CONFIRMED WORLD_BIBLE CANON
    > MASTER_GEAR_BLUEPRINT.md (this document)
      > GEAR_STORY_ARCHITECTURE.md
        > GEAR_EXPERIMENTATION_AND_RESONANCE.md
          > GEAR_COMPONENT_PROFILES.md
            > DOOR_GEAR_SYSTEM.md (overarching principles)
...
- **`GEAR_EXPERIMENTATION_AND_RESONANCE.md`** is the focused subsystem document for Gear↔mechanism interaction, the resonance bridge, wall-contact perception, inscription interpretation layers, Leon's knowledge progression, and the Door interaction stages. It is not duplicated here.
...
Every Gear must have a unique identity. For each, define the following fields (see `GEAR_COMPONENT_PROFILES.md` for full profiles; this section lists requirements):
...
Gears are not confined to Ashford. They may be found in:
