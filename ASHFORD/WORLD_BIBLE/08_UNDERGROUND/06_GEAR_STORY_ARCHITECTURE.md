...
Gear may be located beyond Alderwick: other cities, scholars' hands, hidden inside other objects, auction lots, faction vaults, unknowing owners, old buildings, sites near other phenomena. Travel rule: Leon travels because the investigation demands it, never because a new setting is wanted. Each destination must independently sustain: new characters, local history, local mystery, faction texture, potential member candidates. Loop:
