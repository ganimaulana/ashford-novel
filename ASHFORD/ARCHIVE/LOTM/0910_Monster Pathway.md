...
Second, it was to throw a special item out, causing them to face the test of seeing what shouldn’t be seen and hear what shouldn’t be heard. In this aspect, Klein had a blood crystal that came from a high-level Devil that could produce such an effect—Blatherer’s aura.
...
Do a divination above the gray fog? No, that involves the gray fog itself. The outcome will definitely be interfered with… Rely on my own divination powers in the real world? Klein took out a gold coin and let it run through his fingers.
