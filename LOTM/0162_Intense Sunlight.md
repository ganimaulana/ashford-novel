...
On the wall behind the Sacred Emblem, there were a few openings which allowed sunlight to shine in from the outside. They were focused into tiny specks of pure light which combined with the dark surroundings to form a scene that resembled that of a lofty cosmos.
...
As he finished the magical characters that represented light, the spirituality on both sides of the gold slices suddenly melded together, as the light converged onto the metal.
